...
const DATA = {
  ...
  posts: [
    ...
    },
    {
      ...
      excerpt: 'In a distracted world, depth is a superpower. Here are the ideas that changed how I approach focus and craft.',
      date: 'Mar 1, 2025',
      time: '6 min read',
      emoji: '📗',
...
<span class="kw">def</span> <span class="fn">fib_dp</span>(n):
  ...
  books: [
    ...
    },
    {
      ...
      rating: 5,
      summary: 'The definitive argument that focused, distraction-free work is the key skill of the 21st century and a radical guide to developing it.',
      lessons: [
        'Deep work produces rare and valuable results',
        'Shallow work is everywhere but contributes little lasting value',
        'Schedule your depth intentionally — it won\'t happen by accident',
