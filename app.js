...
<span class="kw">def</span> <span class="fn">fib_dp</span>(n):
  ...
  `,
    ...
    {
  id: 'utkrishtta',
  title: 'उत्कृष्टता — ऊँचा उठने को तैयार हो?',
  author: 'आचार्य प्रशांत',
  emoji: '🌸',
  img: 'excallence.jpeg',
  bg: 'linear-gradient(135deg,#7a4a00 0%,#c47a00 50%,#a06000 100%)',
  rating: 5,
  summary: 'राष्ट्रीय बेस्टसेलर। उत्कृष्टता का अर्थ सिर्फ टॉपर बनना नहीं — बल्कि वो इंसान बनना है जो भीतर से ऊँचा उठ चुका हो। आचार्य प्रशांत बताते हैं कि असली excellence बाहरी उपलब्धियों में नहीं, आत्म-जागरूकता में है।',
  lessons: [
    'उत्कृष्टता डर से नहीं, प्रेम से आती है — जो डर के मारे पढ़ता है, वो कभी श्रेष्ठ नहीं बनता',
    'तुलना करना बंद करो — दूसरों की race में दौड़ना mediocrity है, excellence नहीं',
    'जो काम तुम्हें भीतर से जलाए, वही तुम्हारा असली क्षेत्र है',
    'समाज की परिभाषा में "सफल" बनने की चाहत, उत्कृष्टता की सबसे बड़ी दुश्मन है',
    'श्रेष्ठता एक मंजिल नहीं, जीने का तरीका है',
  ],
  quotes: [
    '"ऊँचा उठना है तो पहले भीतर के बोझ को उतारो।" — आचार्य प्रशांत',
    '"Excellence वो नहीं जो दूसरों को दिखे — वो है जो तुम्हें भीतर से महसूस हो।"',
  ],
  hindiContent: `
    <h2 id="s0">उत्कृष्टता का असली अर्थ</h2>
    <p>हम सब "अच्छा करना" चाहते हैं — परीक्षा में, करियर में, रिश्तों में। लेकिन आचार्य प्रशांत एक तीखा सवाल पूछते हैं — <em>यह "अच्छा करने" की चाहत कहाँ से आती है? प्रेम से या डर से?</em></p>
    <p>अगर डर से — तो यह excellence नहीं, बल्कि एक सुंदर दिखने वाली गुलामी है।</p>
    <blockquote>"जो डर के मारे ऊँचा उठता है, वो असल में और गहरे गिर रहा होता है।"</blockquote>

    <h2 id="s1">तुलना — उत्कृष्टता का सबसे बड़ा दुश्मन</h2>
    <p>Marks, rank, package — यह सब दूसरों से तुलना के पैमाने हैं। जब तुम किसी और की race में दौड़ रहे हो, तो तुम अपनी race खो देते हो। प्रशांत कहते हैं — <strong>श्रेष्ठता वहाँ है जहाँ तुलना नहीं, बस अपना सर्वश्रेष्ठ देने की लगन है।</strong></p>

    <h2 id="s2">ऊँचा कैसे उठें?</h2>
    <p>इस किताब का मूल संदेश है — पहले भीतर के बोझ को उतारो। conditioning, डर, दूसरों की अपेक्षाएं — यह सब वो पत्थर हैं जो तुम्हें नीचे खींचते हैं। जिस दिन यह उतरे, उसी दिन से उत्कृष्टता शुरू होती है।</p>
    <blockquote>"Excellence एक मंजिल नहीं — जीने का तरीका है।"</blockquote>
  `,
},
    {
      id: 'man-meaning',
